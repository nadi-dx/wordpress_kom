<div class="jumbotron" style="background-color: #fff; border: none; padding-top: 0px; padding-bottom: 30px; margin-bottom: 0px;">
  <div class="jumbotron" style="background-color: #ccc;border: none; padding-top: 0px; padding-bottom: 30px; margin-bottom: 0px;">
    <header class="jumbotron" style="background-color: #4679B2; margin-top: 50px;">
      <div class="container">
        <div class="row">
        ...
        <center>
          ...
          <div class="col-md-2 col-sm-4">
            <a href="<?php echo site_ckan();?>/group/sistem-elektronik">
              <img src="<?php echo get_template_directory_uri() .'/img/icon/009-na.png';?>" class="img-responsive" width="70%;">
              <label class="small">Sistem Elektronik</label>
            </a>
          </div>
          <div class="col-md-2 col-sm-4">
            <a href="<?php echo site_ckan();?>/group/alat-dan-perangkat">
              <img src="<?php echo get_template_directory_uri() .'/img/icon/008-n.png';?>" class="img-responsive" width="70%;">
...
<hr>
    ...
    <script type="text/javascript">
      google.charts.load('current', {'packages':['corechart']});
			...
			buildChart(urlOrganizationList, 'bar', 'Dataset menurut Organization', 'donutchart');
			buildChart(urlGroupList, 'pie', 'Dataset menurut Group', 'piechart_3d');
			buildChart(urlFormatList, 'pie', 'Dataset menurut Format', 'chart_lines');
			buildChart(urlTagList, 'bar', 'Dataset menurut Tag', 'chart_div');
